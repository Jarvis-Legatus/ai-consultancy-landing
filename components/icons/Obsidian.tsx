...
const Obsidian = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path fill="url(#obsidian-a)" d="M70.365 307.44c26.638-53.983 25.93-92.722 14.537-120.225-10.372-25.459-29.781-41.489-45.025-51.468a19.233 19.233 0 0 1-1.415 4.243L2.631 219.747a21.923 21.923 0 0 0 4.321 24.36l57.284 58.933a23.762 23.762 0 0 0 6.129 4.4Z" />
    <path
      fill="url(#obsidian-b)"
    ...
    />
    <path fill="url(#obsidian-f)" d="M88.674 188.551c1.571 3.458 2.907 6.287 3.85 10.608l-3.379.786c-1.336-5.029-2.357-8.643-4.322-12.965-11.472-26.953-29.86-40.861-44.79-51.076 18.074 9.744 36.697 25.066 48.64 52.647Z" />
    <path fill="url(#obsidian-g)" d="M92.681 202.617c6.286 29.467-.786 66.948-21.609 103.409 17.445-36.146 25.931-70.8 18.859-102.938l2.75-.55v.079Z" />
    <path
      fill="url(#obsidian-h)"
